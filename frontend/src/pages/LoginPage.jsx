    ...
    <div className="mx-auto max-w-md px-4 py-10">
      <div className="glass-panel p-8 rounded-3xl border border-slate-200/50 dark:border-slate-800/80 shadow-md">
        <div className="flex flex-col items-center mb-6">
          ...
          <h1 className="mt-3 text-xl font-black text-slate-800 dark:text-white">Welcome back</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400">Login to manage lock records</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="mt-1 w-full px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-primary-500"
              placeholder="admin@lockkey.local"
            />
          </div>
          <div>
          ...
          <button
            disabled={loading}
            className="w-full flex items-center justify-center gap-2 bg-gradient-to-tr from-primary-600 to-amber-500 hover:from-primary-700 hover:to-amber-600 text-white font-bold py-3 rounded-xl shadow-md disabled:opacity-50"
          >
        ...
        <p className="mt-6 text-center text-sm text-slate-500">
          No account? <Link to="/register" className="text-primary-600 dark:text-primary-400 font-semibold">Register</Link>
        </p>
      </div>
    </div>
  );
